...
/* Updates the given sprite with the new position and angle*/
...
/* Sets ups the graphics view (buckets and balls) based on the given
 * level and round*/
void JGraphicsView::setupLevel(int level, Type type, bool existing)
{
    ...
    if (level != 3)
    {
        ...
        //Create the objects in the world  (all rounds have at least the first four cups and balls)
        ...
        //Medium and hard rounds have 5 & 6 bucket and balls
        if (type != easy)
        {
        ...
        //Levels 1 and 2 have the smaller big bucket and we hide all the hex balls
        bigBucket->show();
        bigBucket2->hide();
        hexBall0->hide();
        hexBall1->hide();
    ...
    {
        //Hide buckets 2 - 8, all the balls and the smaller big bucket
        cupSprite2->hide();
        cupSprite3->hide();
        cupSprite4->hide();
        cupSprite5->hide();
        ...
        //If the round is easy, hide all the duplicate hex balls and only show bucket 1
        if (type == easy)
        {
            cupStart1.setX(615);
            cupSprite1->setPos(cupStart1);
        ...
        //if the round is hard, show all the duplicate hex balls and buckets 1-2
        if (type == hard)
        {
            cupStart1.setX(800);
            cupSprite1->setPos(cupStart1);
        ...
        //Show all the hex balls for all rounds
       hexBall0->show();
       hexBall1->show();
       hexBall2->show();
       hexBall3->show();
...
/* Creates all the buckets and balls for the game
 * that are displayed on the graphics scene*/
