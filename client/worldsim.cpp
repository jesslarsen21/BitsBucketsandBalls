...
b2Body* WorldSim::createBigBucket(bodydata* data, QPointF pos, bool small)
{
    ...
    if (small)
    {
        ...
        boxShape.SetAsBox((0.1)/b2Qt::SCALE, (154/1.5)/b2Qt::SCALE, b2Vec2(-((100/2)/b2Qt::SCALE), 0.f), 0);
        body->CreateFixture(&boxShape, 1.f); // Left
    ...
    else
    {
        ...
        boxShape.SetAsBox((0.1)/b2Qt::SCALE, (154/1.5)/b2Qt::SCALE, b2Vec2(-((150/2)/b2Qt::SCALE), 0.f), 0);
        body->CreateFixture(&boxShape, 1.f); // Left
