...
clientController::clientController()
{
    ...
    //creating a test password for teacher login
    ...
    connect(levelPtr, SIGNAL(quitGame()), this, SLOT(quitGame()));
...
/* Returns the scores for the given level*/
